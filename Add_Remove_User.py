...
"background-color: rgb(98, 36, 36); font: 20pt 'Arial Rounded MT Bold';")
    ...
    "QHeaderView::section { background-color: rgba(98, 36, 36, 255); color: rgb(255, 255, 255); }"
        )
        ...
        button_styles = "QPushButton { background-color: rgba(98, 36, 36, 255); color: rgb(255, 255, 255); border-radius: 10px; border: 2px solid white; }"
        ...
        table_stylesheet = (
            "QTableWidget {"
            "background-color: rgba(98, 36, 36, 255);"
            "border: none;"
            "}"
        )
        self.tableWidget.setStyleSheet(table_stylesheet)
        self.tableWidget.setStyleSheet("QHeaderView::section { background-color: rgba(98, 36, 36, 255); color: rgb(255, 255, 255); }")
        self.tableWidget.horizontalHeader().setStyleSheet("QHeaderView::section { background-color: rgba(98, 36, 36, 255); }")
