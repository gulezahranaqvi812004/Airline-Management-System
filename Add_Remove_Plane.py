...
"background-color: rgb(98, 36, 36);"))
    ...
    "QTableWidget { background-color: rgba(98, 36, 36, 255); color: rgb(255, 255, 255); }"
    "QHeaderView::section { background-color: rgba(98, 36, 36, 255); color: rgb(255, 255, 255); }"
)
        self.tableWidget.horizontalHeader().setStyleSheet("color: rgb(255, 255, 255); background-color: rgba(98, 36, 36, 255);")

        self.addButton = QtWidgets.QPushButton(self.centralwidget)
        self.addButton.setText("Add Plane")
        self.addButton.setStyleSheet(("color: rgb(255, 255, 255);\n"
"background-color: rgb(98, 36, 36);"))  # Red color for the Add button
...
"background-color: rgb(98, 36, 36);"))  # Red color for the Remove button
