...
"")
    ...
    def retranslateUi(self, Form):
        ...
        item.setText(_translate("Form", "Booked Flight"))
        ...
        self.sCountry.setText(_translate("Form", "BookedFlight"))
        self.searchButton.setText(_translate("Form", "Search"))
        self.fNumber.setText(_translate("Form", "ID"))
        self.pName.setText(_translate("Form", "Email"))
        self.capacity.setText(_translate("Form", "Phone"))
        self.dCountry.setText(_translate("Form", "Source Country"))
        self.date.setText(_translate("Form", "Destination Country"))
        self.label_3.setText(_translate("Form", "Select Column:"))
        self.duaration.setText(_translate("Form", "Date"))
        self.ftype.setText(_translate("Form", "Name"))
